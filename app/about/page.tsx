...
export const metadata: Metadata = {
  title: 'About Us | Bahujan Kranti Party',
  description: 'Learn about Bahujan Kranti Party\'s mission, vision, and values. Dedicated to building a progressive, inclusive, and prosperous India.',
  keywords: 'about Bahujan Kranti Party, mission, vision, party values, political movement',
  openGraph: {
    title: 'About Bahujan Kranti Party | Our Story and Mission',
    description: 'Learn about our commitment to creating positive change and empowering every citizen.',
    url: '/about',
    type: 'website',
  },
};
